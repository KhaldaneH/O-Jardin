    ...
    <>
      ...
      <div className='about-container'>
        <div className='about-text'>
          <h1 style={{color:'green',marginBottom:'20PX'}}>À propos de nous</h1>
          <p style={{color:"gray"}}>
      ...
      <div style={{ backgroundColor:'#1B4D3E',borderRadius:' 1%', marginBottom:"50px"}} className='about-section'>
          <div className='about-text'>
            <h2 style={{fontFamily: 'Lucida Handwriting', fontWeight: 'bold', color: 'white', marginBottom: '20px'}}>Tranquillité et délices au cœur de la nature.</h2>
            <p style={{color:"white"}}>
